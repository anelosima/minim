...
Minim is a forecasting bot for the Metaculus AI forecasting benchmark. Previous iterations of the template bots with SOTA models have placed very well. In my own testing, however, various parts of the bot sometimes fail quite dramatically at their intended task. For example:
